...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn('relative h-[40rem] flex items-center bg-black justify-center w-full group', containerClassName)}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block pb-1 px-1 rounded-lg bg-gradient-to-r from-indigo-500 via-purple-700 to-purple-500`,
        className
      )}>
      {children}
    </motion.span>
